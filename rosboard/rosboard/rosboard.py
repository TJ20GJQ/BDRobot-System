...
#                    qos_file = QoSProfile(
#                            history=kwargs['qos'].history,
#                            depth=kwargs['qos'].depth, 
#                            reliability=kwargs['qos'].reliability, 
#                            durability=kwargs['qos'].durability,
#                            lifespan=kwargs['qos'].lifespan, 
#                            deadline=kwargs['qos'].deadline, 
#                            liveliness=kwargs['qos'].liveliness,
#                            liveliness_lease_duration=kwargs['qos'].liveliness_lease_duration, 
#                            avoid_ros_namespace_conventions=kwargs['qos'].avoid_ros_namespace_conventions)
                    self.local_subs[topic_name] = rospy.Subscriber(
                        topic_name,
                        self.get_msg_class(topic_type),
                        self.on_ros_msg,
                        callback_args = (topic_name, topic_type),
                        **kwargs  # foxy要注释lifespan/deadline/liveliness_lease_duration，默认值问题
                    )
                    # print(self.get_msg_class(topic_type))
                    # print(topic_name, topic_type)
#                    print(kwargs['qos'].history) 
#                    print(kwargs['qos'].depth)
#                    print(kwargs['qos'].reliability) 
#                    print(kwargs['qos'].durability)
#                    print(kwargs['qos'].lifespan)
#                    print(kwargs['qos'].deadline) 
#                    print(kwargs['qos'].liveliness)
#                    print(kwargs['qos'].liveliness_lease_duration)
#                    print(kwargs['qos'].avoid_ros_namespace_conventions)
                    # print('-------------')
                    # print(qos_file.history) 
                    # print(qos_file.depth)
                    # print(qos_file.reliability) 
                    # print(qos_file.durability)
                    # print(qos_file.lifespan)
                    # print(qos_file.deadline) 
                    # print(qos_file.liveliness)
                    # print(qos_file.liveliness_lease_duration)
                    # print(qos_file.avoid_ros_namespace_conventions)
