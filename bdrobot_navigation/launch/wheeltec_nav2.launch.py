...
def generate_launch_description():
    ...
    my_param_file = 'livox_params.yaml'
    ...
    # robot_control_dir = get_package_share_directory('wheeltec_gazebo')
    # robot_control_launch_dir = os.path.join(robot_control_dir, 'launch')
    ...
    #         PythonLaunchDescriptionSource(os.path.join(robot_control_launch_dir, 'mygazebo.launch.py')),
