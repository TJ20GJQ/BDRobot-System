...
def generate_launch_description():
    ...
    my_param_file = 'wheeltec_params.yaml'
    my_bt_file = 'navigate_w_replanning_time.xml'
    my_map_dir = os.path.join(my_nav_dir, 'map')
    my_map_file = 'image_map.yaml'
    default_bt_xml_filename = os.path.join(my_param_dir, 'rrt_navigate_w_replanning_time.xml'),
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={'namespace': namespace,
                              ...
                              'default_bt_xml_filename': my_bt_file,
