...
def generate_launch_description():
    ...
    #                         #   ('urdf_file', os.path.join(get_package_share_directory('bdrobot_description'), 'urdf', 'robot_description.urdf.xacro'))],
    #                           ('urdf_file', os.path.join(get_package_share_directory('bdrobot_moveit_config'), 'config', 'robot_description.urdf.xacro'))],
    # )
